CREATE DATABASE  IF NOT EXISTS `bl_2015_06_film` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `bl_2015_06_film`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win64 (x86_64)
--
-- Host: localhost    Database: bl_2015_06_film
-- ------------------------------------------------------
...
INSERT INTO `film` VALUES (1,'Последњи круг у Монци',2,102,1989,2,7.8,'Interesantno...',1000000,700000),(2,'Ко то тамо пева',5,86,1980,2,8.9,NULL,2000000,700000),(3,'Platoon',4,120,1986,1,8.1,'Rat u Vijetnamu iz ugla 19-godišnjeg regruta',9000000,700000),(4,'Професионалац',5,95,2003,3,7,'Po pozorišnoj predstavi',1500000,700000),(5,'Лепа села лепо горе',4,90,1995,3,8.43,NULL,2200000,700000),(7,'Ми нисмо анђели',5,92,1994,3,7.7,NULL,4000000,700000),(9,'Big Lebowski',5,90,1991,1,10,NULL,2000000,700000),(10,'Full Metal Jacket',4,97,1987,1,8.3,'rat + drama A pragmatic U.S. Marine observes the dehumanizing effects the U.S.-Vietnam War has on his fellow recruits from their brutal boot camp training to the bloody street fighting in Hue.',1300000,700000);
...
--
-- Dumping routines for database 'bl_2015_06_film'
--
...
-- Dump completed on 2015-10-31 22:48:14
